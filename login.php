            ...
            <div class="flex flex-col shadow-2xl shadow-gray-800 rounded my-20 w-full max-w-[500px]">
                <div class="flex flex-row p-4 bg-blue-700 items-center">
                    ...
                    <div class="flex flex-col gap-1 text-white">
                        ...
                        <p class="text-sm">Please Enter your Credentitals to login</p>
                    </div>
                </div>
                <form id="loginForm" class="flex flex-col bg-white gap-5 font-semibold p-4 py-5">
                    ...
                    <div class="flex gap-2 items-center justify-between">
                        <a href="register.php" class="font-bold text-sm text-red-500 hover:text-red-600">New User? Register</a>
                        <button type="submit" class="px-3 py-2 w-fit rounded bg-blue-600 text-white font-semibold hover:bg-blue-800">Login</button>
                    </div>
                </form>
            </div>
        </div>
